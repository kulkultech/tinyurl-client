...
describe("Shorten URL", () => {
  ...
  before(() => {
    tinyUrlResponse =
      ...
      '        <div class="indent"><b>https://tinyurl.com/ydyofn2z</b><div id="success"></div><br><small>[<a href="https://tinyurl.com/ydyofn2z" target="_blank" rel="nofollow">Open in new window</a>]</small><a id="copy_div" href="https://tinyurl.com/ydyofn2z" onclick="return false;" data-clipboard-text="https://tinyurl.com/ydyofn2z"><small>[Copy to clipboard]</small></a></div>\n' +
      "        Or, give your recipients confidence with a preview TinyURL:\n" +
      '        <div class="indent"><b>https://preview.tinyurl.com/ydyofn2z</b><br>\n' +
      '            <small>[<a href="https://preview.tinyurl.com/ydyofn2z" target="_blank">Open in new window</a>]</small>\n' +
      "        </div><p></p>\n" +
      '        <div class="copyinfo" data-clipboard-text="https://tinyurl.com/ydyofn2z"><i><b>How to copy and paste the TinyURL:</b> To copy the TinyURL to your clipboard, right click the link under the TinyURL and select the copy link location option. To paste the TinyURL into a document, press Ctrl and V on your keyboard, or select "paste" from the edit menu of the program you are using.</i></div>\n' +
      "\n" +
      "        \n" +
    ...
    sinon.stub(axios, "get").returns({ data: tinyUrlResponse });
  });
  ...
  describe("Create order without alias", () => {
